  ...
  return (
    <div
      ...
      <motion.h1
        ...
        className="my-20 text-center text-4xl font-light">Get in Touch</motion.h1>
      ...
      <div class=" flex justify-center items-center">
        <div class="relative inline-flex  group">
          ...
          <a href="https://drive.google.com/drive/folders/1yScwwG4Lyyp_dW62EGOgXEBaGDJ05RbJ?usp=sharing" download title="Download my CV"
